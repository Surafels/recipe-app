...
RSpec.describe RecipeFood, type: :model do
  ...
  let!(:recipe) do
    Recipe.create(name: 'Recipe', description: 'Recipe 1', public: true, preparation_time: 5,
                  cooking_time: 2, user_id: user.id)
  end

  let!(:food) do
    Food.create(name: 'Food', user_id: user.id, measurment_unit: 'KG', price: 10, quantity: 10)
  end
